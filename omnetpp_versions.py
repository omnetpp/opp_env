    ...
    return [
        {
            ...
            "external_nix_packages": ["ccache", "which", "bison", "flex", "perl", "xdg-utils", "qt5.qtbase", "qt5.qtsvg", "python3", "python3Packages.numpy", "python3Packages.scipy", "python3Packages.pandas", "python3Packages.matplotlib", "python3Packages.posix_ipc"],
    ...
    return [
        {
            ...
            "external_nix_packages": ["ccache", "bison", "flex", "perl", "xdg-utils", "python3", "qt5.qtbase", "qt5.qtsvg" ],
    ...
    return [
        {
            ...
            "external_nix_packages": ["ccache", "bison", "flex", "perl", "tk", "tcl" ],
            ...
            "setenv_command": "source setenv -i",
