...
def make_omnetpp_project_description(version, base_version=None, is_modernized=False):
    ...
    other_packages = ["llvmPackages.bintools", "bison", "flex", "perl", "bear", "libxml2", "expat", "which", "xdg-utils", "pkg-config", "ccache", "gnumake42", ("gdb" if not is_macos else None), "vim", ("python3" if version > "5.0" else None)]
